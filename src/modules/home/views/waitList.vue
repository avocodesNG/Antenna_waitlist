<template>
  <div>
    <!-- <iframe
      id="JotFormIFrame-230627260756154"
      title="Contact form waitlist"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allowfullscreen="true"
      allow="geolocation; microphone; camera"
      src="https://form.jotform.com/230627260756154"
      frameborder="0"
    ...
    <iframe
      id="JotFormIFrame-230627024847153"
      title="Opt-In Form-Get Free Email Updates!"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allowfullscreen="true"
      allow="geolocation; microphone; camera"
      src="https://form.jotform.com/230627024847153"
      frameborder="0"
...
<!-- <script lang="js">
var ifr = document.getElementById("JotFormIFrame-230627260756154");
if (ifr) {
  var src = ifr.src;
  var iframeParams = [];
...
<script type="text/javascript">
var ifr = document.getElementById("JotFormIFrame-230627024847153");
if (ifr) {
  var src = ifr.src;
  var iframeParams = [];
  if (window.location.href && window.location.href.indexOf("?") > -1) {
